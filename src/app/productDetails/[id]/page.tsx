    ...
    return (
        <div>
            <div className="grid grid-cols-1  md:grid-cols-2 lg:grid-cols-6 gap-5 container mx-auto py-15">
                <figure className='md:col-span-1 lg:col-span-2'>
                ...
                <div className='md:col-span-1 lg:col-span-4 flex-col flex gap-2 justify-center '>
                    ...
                    {product?.priceAfterDiscount ? <div>
                        <span className='text-[#FC7732] text-2xl font-semibold mr-2' >${product?.priceAfterDiscount.toLocaleString('en-US', {
                            style: 'decimal',
                            currency: 'USD',
                        })}</span>
                        <span className='font-semibold text-gray-700 text-sm line-through '>${product?.price.toLocaleString('en-US', {
                            style: 'decimal',
                            currency: 'USD',
                        })}</span>
                    </div> : <span className='text-[#FC7732] text-2xl font-semibold '>${product?.price.toLocaleString('en-US', {
                        style: 'decimal',
                        currency: 'USD',
                    })}</span>}
                    ...
                    <figcaption className='md:col-span-2 lg:col-span-5 mt-1.5'>
