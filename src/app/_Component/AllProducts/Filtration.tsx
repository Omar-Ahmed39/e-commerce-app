        ...
        <>
            ...
            <DropdownMenu modal={false}>
                <DropdownMenuTrigger asChild className='w-full py-5 lg:hidden'>
                    <Button variant="outline" className='mb-8 bg-[#102051] px-3 text-white rounded-lg cursor-pointer border-2 hover:border-[#102051] hover:bg-white hover:text-[#102051]  duration-200 text-xl'>Filters</Button>
                </DropdownMenuTrigger>
